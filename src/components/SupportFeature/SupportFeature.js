...
function SupportFeature() {
	return (
		<div className="main">
						...
						<div className="row ">
							<div className="col-md-4">
								...
								<div className="sub-heading">
									...
									<div className="para">
										<p>
											Lorem ipsum dolor sit amet. Et aliquam autem ex ducimus
											atque non iusto nihiaS technology
										</p>
									</div>
								</div>
							</div>
			...
			<div className="footer-box mt-5"></div>
		</div>
	);
}
