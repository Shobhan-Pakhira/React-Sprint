...
import protection from '../assets/medicine-bottle.svg'
import customer from '../assets/client-care.svg'
        ...
        <div className='top-part'>
            <div className='info-cards-group'>
                <div className='info-cards'>
                    ...
                    <p className='card-info'>nunc id cursus metus aliquam eleifend mi in nulla posuere sollicitudin aliquam</p>
                </div>
                <div className='info-cards'>
                    <div className='circle'></div>
            ...
            <div className='side-content'>
                ...
                <h5 className='sub-text'> Lorem Ipsum is simply dummy text of the printing <br/> and typesetting industry. </h5>
                <p className='info-text'>Enhance your preliminatry diagnosis and tiage with pediatric content...</p>
        ...
        <div className='bottom-part'>
            <div className='bottom-card-left'>
                ...
                <div className='text-holder'>
                    ...
                    <p className='sub-content'>Help you measure your skill and help you solve problem faster </p>
                </div>
            </div>
